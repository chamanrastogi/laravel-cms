...
class RouteServiceProvider extends ServiceProvider
{
    ...
    protected function mapMenugroupRoutes()
    {
        Route::middleware('web')
        ->namespace($this->namespace)
        ->group(base_path('routes/web/menu_group.php'));
    }
    protected function mapMenusRoutes()
    {
        Route::middleware('web')
        ->namespace($this->namespace)
        ->group(base_path('routes/web/menu.php'));
    }
