...
@endsection
	...
	<div class="box-content card white">
		<h4 class="box-title">Add Permission        
		...
		<div class="card-content">
			  ...
			  @endif
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						{!! Form::text('name', $value = null, ['class' => 'form-control','id'=>'name', 'placeholder' => 'Permission Name']) !!}
					</div>
				</div>
				<div class="form-group">
					{!! Form::label('slug', 'Permission Slug:', ['class' => 'col-md-2 control-label']) !!}
					<div class="col-lg-10">
						{!! Form::text('slug', $value = null, ['class' => 'form-control','id'=>'slug','readonly' => 'true','placeholder' => 'Permission Slug']) !!}
					</div>
				</div>
