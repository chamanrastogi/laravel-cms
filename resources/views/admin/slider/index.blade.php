...
@endsection
	...
	<div class="box-content card white">
		<h4 class="box-title ">Show Slider        
				...
				<tr>
					...
					<td>						
						<ul class="list-inline">
							<li><a href="{{route('slider.edit',$m->id)}}" class="btn btn-info btn-circle btn-xs waves-effect waves-light">
								<i class="ico fa fa-pencil "></i></a>	</li><li>					
								{!! Form::open([
									'method' => 'DELETE',
									'route' => ['slider.destroy', $m->id],
									'class' => 'form-horizontal'
								]) !!}
