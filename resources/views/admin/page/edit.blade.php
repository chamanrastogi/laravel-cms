		  ...
		  {!! Form::open([
			...
			'files'=>true
				...
				<div class="form-group">
					...
					<div class="col-lg-10">				
						{!! Form::select('mid', $menu,$data->mid, ['class'=>'form-control select2_1 '])!!}
					</div>
				</div>
				<div class="form-group">
					{!! Form::label('title', 'Page Title:', ['class' => 'col-md-2 control-label']) !!}
					<div class="col-lg-10">
						{!! Form::text('title', $value = $data->title, ['class' => 'form-control', 'placeholder' => 'Page Title']) !!}
					</div>
				</div>				
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						{!! Form::textarea('meta_keywords', $value = $data->meta_keywords, ['class' => 'form-control','rows'=>'1','placeholder' => 'Meta Keywords']) !!}
					</div>
				</div>
				<div class="form-group">
					{!! Form::label('meta_desc', 'Meta Description:', ['class' => 'col-md-2 control-label']) !!}
					<div class="col-lg-10">
						{!! Form::textarea('meta_desc', $value = $data->meta_desc, ['class' => 'form-control','rows'=>'1','placeholder' => 'Meta Description']) !!}
					</div>
				</div>
				<div class="form-group">
					{!! Form::label('text', 'Page Body:', ['class' => 'col-md-2 control-label']) !!}
					<div class="col-lg-10">
						{!! Form::textarea('text', $value = $data->text, ['class' => 'form-control','id' => 'demotest', 'placeholder' => 'Page Body']) !!}
					</div>
				</div>
