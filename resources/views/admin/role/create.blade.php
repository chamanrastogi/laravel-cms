		...
		<div class="card-content">
			  ...
			  @endif
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						{!! Form::text('name', $value = null, ['class' => 'form-control','id'=>'name', 'placeholder' => 'Role Name']) !!}
					</div>
				</div>
				<div class="form-group">
					{!! Form::label('slug', 'Role Slug:', ['class' => 'col-md-2 control-label']) !!}
					<div class="col-lg-10">
						{!! Form::text('slug', $value = null, ['class' => 'form-control','id'=>'slug','readonly' => 'true','placeholder' => 'Role Slug']) !!}
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-lg-10">
						...
						{!! Form::select('permissions[]', $permissions,null, ['multiple'=>'multiple','class'=>'form-control select2_1 '])!!}
					</div>
				</div>
