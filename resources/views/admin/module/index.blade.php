...
@endsection
	...
	<div class="box-content card white">
		<h4 class="box-title ">Show Module        
		...
		<table id="example" class="table table-striped table-bordered display" style="width:100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>{{ucfirst($m->heading)}}</td>
					
					<td>
						@if($m->image!='')
						<div style="width:250px"> <a class="item-gallery lightview " data-lightview-group="group" href="{{ $m->image_path()}}">
						<img src="{{ $m->image_path()}}" class="img-responsive"></a></div></td>
						@endif
				
					<td>						
						<ul class="list-inline">
							<li><a href="{{route('module.edit',$m->id)}}" class="btn btn-info btn-circle btn-xs waves-effect waves-light">
								<i class="ico fa fa-pencil "></i></a>	</li><li>
																			
								{!! Form::open([
									'method' => 'DELETE',
									'route' => ['module.destroy', $m->id],
