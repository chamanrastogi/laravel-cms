...
@endsection
	...
	<div class="box-content card white">
		<h4 class="box-title ">Show Gallery        
		...
		<table id="example" class="table table-striped table-bordered display" style="width:100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>{!! Form::open([
						'method' => 'patch',
						'route' => ['gallery.status', $m->id],
						'class' => 'form-horizontal'
					]) !!}				
				
				{!! Form::button($m->status()[0], ['type' => 'submit', 'class' => 'btn btn-'.$m->status()[1].' btn-xs waves-effect waves-light'] ) 
				!!}
				{!! Form::close()  !!}</td>
					
					<td>						
						<ul class="list-inline">
							<li><a href="{{route('gallery.edit',$m->id)}}" class="btn btn-info btn-circle btn-xs waves-effect waves-light">
								<i class="ico fa fa-pencil "></i></a>		</li>
								<li>						
								{!! Form::open([
									'method' => 'DELETE',
									'route' => ['gallery.destroy', $m->id],
									'class' => 'form-horizontal'
								]) !!}
